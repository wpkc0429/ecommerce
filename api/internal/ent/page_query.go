...
func (_q *PageQuery) QueryShop() *ShopQuery {
...
func (_q *PageQuery) WithShop(opts ...func(*ShopQuery)) *PageQuery {
	query := (&ShopClient{config: _q.config}).Query()
...
func (_q *PageQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Page, error) {
	...
	if query := _q.withShop; query != nil {
		if err := _q.loadShop(ctx, query, nodes, nil,
			func(n *Page, e *Shop) { n.Edges.Shop = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *PageQuery) loadShop(ctx context.Context, query *ShopQuery, nodes []*Page, init func(*Page), assign func(*Page, *Shop)) error {
...
func (_q *PageQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withShop != nil {
			_spec.Node.AddColumnOnce(page.FieldShopID)
		}
	}
...
func (_q *PageQuery) ForUpdate(opts ...sql.LockOption) *PageQuery {
...
func (_q *PageQuery) ForShare(opts ...sql.LockOption) *PageQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
...
func (_q *PageQuery) Modify(modifiers ...func(s *sql.Selector)) *PageSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *PageSelect) Modify(modifiers ...func(s *sql.Selector)) *PageSelect {
