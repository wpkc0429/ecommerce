...
func (_q *OrderItemQuery) QueryShop() *ShopQuery {
...
func (_q *OrderItemQuery) WithShop(opts ...func(*ShopQuery)) *OrderItemQuery {
	query := (&ShopClient{config: _q.config}).Query()
...
func (_q *OrderItemQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*OrderItem, error) {
	...
	if query := _q.withShop; query != nil {
		if err := _q.loadShop(ctx, query, nodes, nil,
			func(n *OrderItem, e *Shop) { n.Edges.Shop = e }); err != nil {
			return nil, err
		}
	}
...
func (_q *OrderItemQuery) loadShop(ctx context.Context, query *ShopQuery, nodes []*OrderItem, init func(*OrderItem), assign func(*OrderItem, *Shop)) error {
...
func (_q *OrderItemQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withShop != nil {
			_spec.Node.AddColumnOnce(orderitem.FieldShopID)
		}
		if _q.withOrder != nil {
