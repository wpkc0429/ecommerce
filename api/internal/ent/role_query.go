...
func (_q *RoleQuery) QueryRoleUsers() *RoleUserQuery {
...
func (_q *RoleQuery) WithRoleUsers(opts ...func(*RoleUserQuery)) *RoleQuery {
	query := (&RoleUserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *RoleQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Role, error) {
	...
	if query := _q.withRoleUsers; query != nil {
		if err := _q.loadRoleUsers(ctx, query, nodes,
			func(n *Role) { n.Edges.RoleUsers = []*RoleUser{} },
			func(n *Role, e *RoleUser) { n.Edges.RoleUsers = append(n.Edges.RoleUsers, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *RoleQuery) loadRoleUsers(ctx context.Context, query *RoleUserQuery, nodes []*Role, init func(*Role), assign func(*Role, *RoleUser)) error {
	...
	query.Where(predicate.RoleUser(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(role.RoleUsersColumn), fks...))
	}))
