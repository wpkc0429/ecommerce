...
func (_q *PaymentQuery) QueryShop() *ShopQuery {
...
func (_q *PaymentQuery) WithShop(opts ...func(*ShopQuery)) *PaymentQuery {
	query := (&ShopClient{config: _q.config}).Query()
...
func (_q *PaymentQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Payment, error) {
	...
	if query := _q.withShop; query != nil {
		if err := _q.loadShop(ctx, query, nodes, nil,
			func(n *Payment, e *Shop) { n.Edges.Shop = e }); err != nil {
			return nil, err
		}
	}
...
func (_q *PaymentQuery) loadShop(ctx context.Context, query *ShopQuery, nodes []*Payment, init func(*Payment), assign func(*Payment, *Shop)) error {
...
func (_q *PaymentQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withShop != nil {
			_spec.Node.AddColumnOnce(payment.FieldShopID)
		}
		if _q.withOrder != nil {
