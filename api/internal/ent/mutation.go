...
func withMemberTierID(id int) membertierOption {
...
// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *MemberTierMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *MemberTierMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
...
// SetShopID sets the "shop_id" field.
func (m *MemberTierMutation) SetShopID(i int) {
	m.shop = &i
}

// ShopID returns the value of the "shop_id" field in the mutation.
func (m *MemberTierMutation) ShopID() (r int, exists bool) {
	v := m.shop
	if v == nil {
		return
	}
...
// OldShopID returns the old "shop_id" field's value of the MemberTier entity.
// If the MemberTier object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *MemberTierMutation) OldShopID(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldShopID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetShopID resets all changes to the "shop_id" field.
func (m *MemberTierMutation) ResetShopID() {
	m.shop = nil
}
...
func (m *MemberTierMutation) SetMinPoints(i int32) {
	m.min_points = &i
	m.addmin_points = nil
}

// MinPoints returns the value of the "min_points" field in the mutation.
func (m *MemberTierMutation) MinPoints() (r int32, exists bool) {
	v := m.min_points
	if v == nil {
		return
	}
...
// OldMinPoints returns the old "min_points" field's value of the MemberTier entity.
// If the MemberTier object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *MemberTierMutation) OldMinPoints(ctx context.Context) (v int32, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *MemberTierMutation) AddMinPoints(i int32) {
...
func (m *MemberTierMutation) AddedMinPoints() (r int32, exists bool) {
	v := m.addmin_points
	if v == nil {
		return
	}
...
func (m *MemberTierMutation) ResetMinPoints() {
	m.min_points = nil
	m.addmin_points = nil
}

// SetDiscountPercent sets the "discount_percent" field.
func (m *MemberTierMutation) SetDiscountPercent(i int16) {
...
func (m *MemberTierMutation) DiscountPercent() (r int16, exists bool) {
...
// OldDiscountPercent returns the old "discount_percent" field's value of the MemberTier entity.
// If the MemberTier object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *MemberTierMutation) OldDiscountPercent(ctx context.Context) (v *int16, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *MemberTierMutation) AddDiscountPercent(i int16) {
...
func (m *MemberTierMutation) AddedDiscountPercent() (r int16, exists bool) {
...
func (m *MemberTierMutation) ClearDiscountPercent() {
	m.discount_percent = nil
	m.adddiscount_percent = nil
	m.clearedFields[membertier.FieldDiscountPercent] = struct{}{}
}

// DiscountPercentCleared returns if the "discount_percent" field was cleared in this mutation.
func (m *MemberTierMutation) DiscountPercentCleared() bool {
	_, ok := m.clearedFields[membertier.FieldDiscountPercent]
	return ok
}

// ResetDiscountPercent resets all changes to the "discount_percent" field.
func (m *MemberTierMutation) ResetDiscountPercent() {
	m.discount_percent = nil
	m.adddiscount_percent = nil
	delete(m.clearedFields, membertier.FieldDiscountPercent)
}

// ClearShop clears the "shop" edge to the Shop entity.
func (m *MemberTierMutation) ClearShop() {
	m.clearedshop = true
	m.clearedFields[membertier.FieldShopID] = struct{}{}
}

// ShopCleared reports if the "shop" edge to the Shop entity was cleared.
func (m *MemberTierMutation) ShopCleared() bool {
	return m.clearedshop
}
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// ShopID instead. It exists only for internal usage by the builders.
func (m *MemberTierMutation) ShopIDs() (ids []int) {
	if id := m.shop; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetShop resets all changes to the "shop" edge.
func (m *MemberTierMutation) ResetShop() {
	m.shop = nil
	m.clearedshop = false
}
...
func (m *MemberTierMutation) Fields() []string {
	...
	if m.shop != nil {
		fields = append(fields, membertier.FieldShopID)
	}
	if m.name != nil {
		fields = append(fields, membertier.FieldName)
	}
	if m.min_points != nil {
		fields = append(fields, membertier.FieldMinPoints)
	}
	if m.discount_percent != nil {
		fields = append(fields, membertier.FieldDiscountPercent)
	}
	return fields
}
...
func (m *MemberTierMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(membertier.FieldDiscountPercent) {
		fields = append(fields, membertier.FieldDiscountPercent)
	}
	return fields
}
...
func (m *MemberTierMutation) AddedEdges() []string {
	...
	if m.shop != nil {
		edges = append(edges, membertier.EdgeShop)
	}
	return edges
}
...
// SetShopID sets the "shop_id" field.
func (m *PaymentMutation) SetShopID(i int) {
	m.shop = &i
}

// ShopID returns the value of the "shop_id" field in the mutation.
func (m *PaymentMutation) ShopID() (r int, exists bool) {
	v := m.shop
	if v == nil {
		return
	}
...
// OldShopID returns the old "shop_id" field's value of the Payment entity.
// If the Payment object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *PaymentMutation) OldShopID(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldShopID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetShopID resets all changes to the "shop_id" field.
func (m *PaymentMutation) ResetShopID() {
	m.shop = nil
}
...
func (m *PaymentMutation) SetProviderReference(s string) {
	m.provider_reference = &s
}

// ProviderReference returns the value of the "provider_reference" field in the mutation.
func (m *PaymentMutation) ProviderReference() (r string, exists bool) {
...
// OldProviderReference returns the old "provider_reference" field's value of the Payment entity.
// If the Payment object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *PaymentMutation) OldProviderReference(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *PaymentMutation) ResetProviderReference() {
...
// SetStatus sets the "status" field.
func (m *PaymentMutation) SetStatus(i int16) {
	m.status = &i
	m.addstatus = nil
}

// Status returns the value of the "status" field in the mutation.
func (m *PaymentMutation) Status() (r int16, exists bool) {
	v := m.status
	if v == nil {
		return
	}
...
// If the Payment object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *PaymentMutation) OldStatus(ctx context.Context) (v int16, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldStatus is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddStatus adds i to the "status" field.
func (m *PaymentMutation) AddStatus(i int16) {
	if m.addstatus != nil {
		*m.addstatus += i
	} else {
		m.addstatus = &i
...
// AddedStatus returns the value that was added to the "status" field in this mutation.
func (m *PaymentMutation) AddedStatus() (r int16, exists bool) {
	v := m.addstatus
	if v == nil {
		return
	}
...
// ClearShop clears the "shop" edge to the Shop entity.
func (m *PaymentMutation) ClearShop() {
	m.clearedshop = true
	m.clearedFields[payment.FieldShopID] = struct{}{}
}

// ShopCleared reports if the "shop" edge to the Shop entity was cleared.
func (m *PaymentMutation) ShopCleared() bool {
	return m.clearedshop
}
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// ShopID instead. It exists only for internal usage by the builders.
func (m *PaymentMutation) ShopIDs() (ids []int) {
	if id := m.shop; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetShop resets all changes to the "shop" edge.
func (m *PaymentMutation) ResetShop() {
	m.shop = nil
	m.clearedshop = false
}
...
func (m *PaymentMutation) Fields() []string {
	...
	if m.shop != nil {
		fields = append(fields, payment.FieldShopID)
	}
	if m._order != nil {
	...
	if m.provider_reference != nil {
		fields = append(fields, payment.FieldProviderReference)
	}
	if m.amount != nil {
...
func (m *PaymentMutation) AddedEdges() []string {
	edges := make([]string, 0, 2)
	if m.shop != nil {
		edges = append(edges, payment.EdgeShop)
	}
	if m._order != nil {
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *PointTransactionMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().PointTransaction.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetCreatedAt sets the "created_at" field.
func (m *PointTransactionMutation) SetCreatedAt(t time.Time) {
	m.created_at = &t
}

// CreatedAt returns the value of the "created_at" field in the mutation.
func (m *PointTransactionMutation) CreatedAt() (r time.Time, exists bool) {
	v := m.created_at
	if v == nil {
		return
	}
...
// OldCreatedAt returns the old "created_at" field's value of the PointTransaction entity.
// If the PointTransaction object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *PointTransactionMutation) OldCreatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCreatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetCreatedAt resets all changes to the "created_at" field.
func (m *PointTransactionMutation) ResetCreatedAt() {
	m.created_at = nil
}

// SetUpdatedAt sets the "updated_at" field.
func (m *PointTransactionMutation) SetUpdatedAt(t time.Time) {
	m.updated_at = &t
}

// UpdatedAt returns the value of the "updated_at" field in the mutation.
func (m *PointTransactionMutation) UpdatedAt() (r time.Time, exists bool) {
	v := m.updated_at
	if v == nil {
		return
	}
...
// OldUpdatedAt returns the old "updated_at" field's value of the PointTransaction entity.
// If the PointTransaction object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *PointTransactionMutation) OldUpdatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUpdatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetUpdatedAt resets all changes to the "updated_at" field.
func (m *PointTransactionMutation) ResetUpdatedAt() {
	m.updated_at = nil
}

// SetShopID sets the "shop_id" field.
func (m *PointTransactionMutation) SetShopID(i int) {
	m.shop = &i
}

// ShopID returns the value of the "shop_id" field in the mutation.
func (m *PointTransactionMutation) ShopID() (r int, exists bool) {
	v := m.shop
	if v == nil {
		return
	}
...
// OldShopID returns the old "shop_id" field's value of the PointTransaction entity.
// If the PointTransaction object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *PointTransactionMutation) OldShopID(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldShopID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetShopID resets all changes to the "shop_id" field.
func (m *PointTransactionMutation) ResetShopID() {
	m.shop = nil
}

// SetShopMemberID sets the "shop_member_id" field.
func (m *PointTransactionMutation) SetShopMemberID(i int) {
	m.shop_member = &i
}

// ShopMemberID returns the value of the "shop_member_id" field in the mutation.
func (m *PointTransactionMutation) ShopMemberID() (r int, exists bool) {
	v := m.shop_member
	if v == nil {
		return
	}
...
// OldShopMemberID returns the old "shop_member_id" field's value of the PointTransaction entity.
// If the PointTransaction object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *PointTransactionMutation) OldShopMemberID(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldShopMemberID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldShopMemberID requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldShopMemberID: %w", err)
	}
	return oldValue.ShopMemberID, nil
}

// ResetShopMemberID resets all changes to the "shop_member_id" field.
func (m *PointTransactionMutation) ResetShopMemberID() {
	m.shop_member = nil
}

// SetOrderID sets the "order_id" field.
func (m *PointTransactionMutation) SetOrderID(i int) {
	m._order = &i
}

// OrderID returns the value of the "order_id" field in the mutation.
func (m *PointTransactionMutation) OrderID() (r int, exists bool) {
	v := m._order
	if v == nil {
		return
	}
...
// OldOrderID returns the old "order_id" field's value of the PointTransaction entity.
// If the PointTransaction object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *PointTransactionMutation) OldOrderID(ctx context.Context) (v *int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldOrderID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
func (m *PointTransactionMutation) ClearOrderID() {
	m._order = nil
	m.clearedFields[pointtransaction.FieldOrderID] = struct{}{}
}

// OrderIDCleared returns if the "order_id" field was cleared in this mutation.
func (m *PointTransactionMutation) OrderIDCleared() bool {
	_, ok := m.clearedFields[pointtransaction.FieldOrderID]
	return ok
}

// ResetOrderID resets all changes to the "order_id" field.
func (m *PointTransactionMutation) ResetOrderID() {
	m._order = nil
	delete(m.clearedFields, pointtransaction.FieldOrderID)
}

// SetPointsDelta sets the "points_delta" field.
func (m *PointTransactionMutation) SetPointsDelta(i int32) {
	m.points_delta = &i
	m.addpoints_delta = nil
}

// PointsDelta returns the value of the "points_delta" field in the mutation.
func (m *PointTransactionMutation) PointsDelta() (r int32, exists bool) {
	v := m.points_delta
	if v == nil {
		return
	}
...
// OldPointsDelta returns the old "points_delta" field's value of the PointTransaction entity.
// If the PointTransaction object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *PointTransactionMutation) OldPointsDelta(ctx context.Context) (v int32, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldPointsDelta is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldPointsDelta requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldPointsDelta: %w", err)
	}
	return oldValue.PointsDelta, nil
}

// AddPointsDelta adds i to the "points_delta" field.
func (m *PointTransactionMutation) AddPointsDelta(i int32) {
	if m.addpoints_delta != nil {
		*m.addpoints_delta += i
	} else {
		m.addpoints_delta = &i
	}
...
// AddedPointsDelta returns the value that was added to the "points_delta" field in this mutation.
func (m *PointTransactionMutation) AddedPointsDelta() (r int32, exists bool) {
	v := m.addpoints_delta
	if v == nil {
		return
	}
...
// ResetPointsDelta resets all changes to the "points_delta" field.
func (m *PointTransactionMutation) ResetPointsDelta() {
	m.points_delta = nil
	m.addpoints_delta = nil
}

// SetKind sets the "kind" field.
func (m *PointTransactionMutation) SetKind(i int16) {
	m.kind = &i
	m.addkind = nil
}

// Kind returns the value of the "kind" field in the mutation.
func (m *PointTransactionMutation) Kind() (r int16, exists bool) {
	v := m.kind
	if v == nil {
		return
	}
...
// OldKind returns the old "kind" field's value of the PointTransaction entity.
// If the PointTransaction object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *PointTransactionMutation) OldKind(ctx context.Context) (v int16, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *PointTransactionMutation) AddKind(i int16) {
	if m.addkind != nil {
		*m.addkind += i
	} else {
		m.addkind = &i
...
func (m *PointTransactionMutation) AddedKind() (r int16, exists bool) {
	v := m.addkind
	if v == nil {
		return
	}
...
func (m *PointTransactionMutation) ResetKind() {
	m.kind = nil
	m.addkind = nil
}

// SetReason sets the "reason" field.
func (m *PointTransactionMutation) SetReason(s string) {
	m.reason = &s
}

// Reason returns the value of the "reason" field in the mutation.
func (m *PointTransactionMutation) Reason() (r string, exists bool) {
	v := m.reason
	if v == nil {
		return
	}
...
// OldReason returns the old "reason" field's value of the PointTransaction entity.
// If the PointTransaction object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *PointTransactionMutation) OldReason(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *PointTransactionMutation) ResetReason() {
	m.reason = nil
}

// ClearShop clears the "shop" edge to the Shop entity.
func (m *PointTransactionMutation) ClearShop() {
	m.clearedshop = true
	m.clearedFields[pointtransaction.FieldShopID] = struct{}{}
}

// ShopCleared reports if the "shop" edge to the Shop entity was cleared.
func (m *PointTransactionMutation) ShopCleared() bool {
	return m.clearedshop
}
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// ShopID instead. It exists only for internal usage by the builders.
func (m *PointTransactionMutation) ShopIDs() (ids []int) {
	if id := m.shop; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetShop resets all changes to the "shop" edge.
func (m *PointTransactionMutation) ResetShop() {
	m.shop = nil
	m.clearedshop = false
}

// ClearShopMember clears the "shop_member" edge to the ShopMember entity.
func (m *PointTransactionMutation) ClearShopMember() {
	m.clearedshop_member = true
	m.clearedFields[pointtransaction.FieldShopMemberID] = struct{}{}
}

// ShopMemberCleared reports if the "shop_member" edge to the ShopMember entity was cleared.
func (m *PointTransactionMutation) ShopMemberCleared() bool {
	return m.clearedshop_member
}

// ShopMemberIDs returns the "shop_member" edge IDs in the mutation.
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// ShopMemberID instead. It exists only for internal usage by the builders.
func (m *PointTransactionMutation) ShopMemberIDs() (ids []int) {
	if id := m.shop_member; id != nil {
		ids = append(ids, *id)
	}
	return
}

// ResetShopMember resets all changes to the "shop_member" edge.
func (m *PointTransactionMutation) ResetShopMember() {
	m.shop_member = nil
	m.clearedshop_member = false
}

// ClearOrder clears the "order" edge to the Order entity.
func (m *PointTransactionMutation) ClearOrder() {
	m.cleared_order = true
	m.clearedFields[pointtransaction.FieldOrderID] = struct{}{}
}

// OrderCleared reports if the "order" edge to the Order entity was cleared.
func (m *PointTransactionMutation) OrderCleared() bool {
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// OrderID instead. It exists only for internal usage by the builders.
func (m *PointTransactionMutation) OrderIDs() (ids []int) {
	if id := m._order; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetOrder resets all changes to the "order" edge.
func (m *PointTransactionMutation) ResetOrder() {
	m._order = nil
	m.cleared_order = false
}

// Where appends a list predicates to the PointTransactionMutation builder.
func (m *PointTransactionMutation) Where(ps ...predicate.PointTransaction) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the PointTransactionMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *PointTransactionMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.PointTransaction, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// SetOp allows setting the mutation operation.
func (m *PointTransactionMutation) SetOp(op Op) {
	m.op = op
}
...
func (m *PointTransactionMutation) Fields() []string {
	fields := make([]string, 0, 8)
	if m.created_at != nil {
		fields = append(fields, pointtransaction.FieldCreatedAt)
	}
	if m.updated_at != nil {
		fields = append(fields, pointtransaction.FieldUpdatedAt)
	}
	if m.shop != nil {
		fields = append(fields, pointtransaction.FieldShopID)
	}
	if m.shop_member != nil {
		fields = append(fields, pointtransaction.FieldShopMemberID)
	}
	if m._order != nil {
		fields = append(fields, pointtransaction.FieldOrderID)
	}
	if m.points_delta != nil {
		fields = append(fields, pointtransaction.FieldPointsDelta)
	}
	if m.kind != nil {
		fields = append(fields, pointtransaction.FieldKind)
	}
	if m.reason != nil {
		fields = append(fields, pointtransaction.FieldReason)
	}
	return fields
}
...
func (m *PointTransactionMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	...
	case pointtransaction.FieldShopID:
		return m.OldShopID(ctx)
	case pointtransaction.FieldShopMemberID:
		return m.OldShopMemberID(ctx)
	case pointtransaction.FieldOrderID:
		return m.OldOrderID(ctx)
	case pointtransaction.FieldPointsDelta:
		return m.OldPointsDelta(ctx)
	case pointtransaction.FieldKind:
...
func (m *PointTransactionMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(pointtransaction.FieldOrderID) {
		fields = append(fields, pointtransaction.FieldOrderID)
	}
	return fields
}
...
func (m *PointTransactionMutation) AddedEdges() []string {
	edges := make([]string, 0, 3)
	if m.shop != nil {
		edges = append(edges, pointtransaction.EdgeShop)
	}
	if m.shop_member != nil {
		edges = append(edges, pointtransaction.EdgeShopMember)
	}
	if m._order != nil {
		edges = append(edges, pointtransaction.EdgeOrder)
	}
	return edges
}
...
func (m *PointTransactionMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case pointtransaction.EdgeShop:
		if id := m.shop; id != nil {
			return []ent.Value{*id}
		}
	case pointtransaction.EdgeShopMember:
		if id := m.shop_member; id != nil {
			return []ent.Value{*id}
		}
	case pointtransaction.EdgeOrder:
		if id := m._order; id != nil {
			return []ent.Value{*id}
		}
	}
...
// SetShopID sets the "shop_id" field.
func (m *ShipmentMutation) SetShopID(i int) {
	m.shop = &i
}

// ShopID returns the value of the "shop_id" field in the mutation.
func (m *ShipmentMutation) ShopID() (r int, exists bool) {
	v := m.shop
	if v == nil {
		return
	}
...
// OldShopID returns the old "shop_id" field's value of the Shipment entity.
// If the Shipment object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ShipmentMutation) OldShopID(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldShopID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetShopID resets all changes to the "shop_id" field.
func (m *ShipmentMutation) ResetShopID() {
	m.shop = nil
}

// SetOrderID sets the "order_id" field.
func (m *ShipmentMutation) SetOrderID(i int) {
	m._order = &i
}

// OrderID returns the value of the "order_id" field in the mutation.
func (m *ShipmentMutation) OrderID() (r int, exists bool) {
	v := m._order
	if v == nil {
		return
	}
...
// If the Shipment object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ShipmentMutation) OldOrderID(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldOrderID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
func (m *ShipmentMutation) ClearTrackingNumber() {
	m.tracking_number = nil
	m.clearedFields[shipment.FieldTrackingNumber] = struct{}{}
}

// TrackingNumberCleared returns if the "tracking_number" field was cleared in this mutation.
func (m *ShipmentMutation) TrackingNumberCleared() bool {
	_, ok := m.clearedFields[shipment.FieldTrackingNumber]
	return ok
}
...
func (m *ShipmentMutation) ResetTrackingNumber() {
	m.tracking_number = nil
	delete(m.clearedFields, shipment.FieldTrackingNumber)
}

// SetStatus sets the "status" field.
func (m *ShipmentMutation) SetStatus(i int16) {
	m.status = &i
	m.addstatus = nil
}

// Status returns the value of the "status" field in the mutation.
func (m *ShipmentMutation) Status() (r int16, exists bool) {
	v := m.status
	if v == nil {
		return
	}
...
// If the Shipment object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ShipmentMutation) OldStatus(ctx context.Context) (v int16, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldStatus is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddStatus adds i to the "status" field.
func (m *ShipmentMutation) AddStatus(i int16) {
	if m.addstatus != nil {
		*m.addstatus += i
	} else {
		m.addstatus = &i
...
// AddedStatus returns the value that was added to the "status" field in this mutation.
func (m *ShipmentMutation) AddedStatus() (r int16, exists bool) {
	v := m.addstatus
	if v == nil {
		return
	}
...
func (m *ShipmentMutation) SetShippedAt(t time.Time) {
	m.shipped_at = &t
}

// ShippedAt returns the value of the "shipped_at" field in the mutation.
func (m *ShipmentMutation) ShippedAt() (r time.Time, exists bool) {
	v := m.shipped_at
	if v == nil {
		return
	}
...
// OldShippedAt returns the old "shipped_at" field's value of the Shipment entity.
// If the Shipment object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ShipmentMutation) OldShippedAt(ctx context.Context) (v *time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ShipmentMutation) ClearShippedAt() {
	m.shipped_at = nil
	m.clearedFields[shipment.FieldShippedAt] = struct{}{}
}

// ShippedAtCleared returns if the "shipped_at" field was cleared in this mutation.
func (m *ShipmentMutation) ShippedAtCleared() bool {
	_, ok := m.clearedFields[shipment.FieldShippedAt]
	return ok
}

// ResetShippedAt resets all changes to the "shipped_at" field.
func (m *ShipmentMutation) ResetShippedAt() {
	m.shipped_at = nil
	delete(m.clearedFields, shipment.FieldShippedAt)
}

// SetDeliveredAt sets the "delivered_at" field.
func (m *ShipmentMutation) SetDeliveredAt(t time.Time) {
	m.delivered_at = &t
}

// DeliveredAt returns the value of the "delivered_at" field in the mutation.
func (m *ShipmentMutation) DeliveredAt() (r time.Time, exists bool) {
	v := m.delivered_at
	if v == nil {
		return
	}
...
// OldDeliveredAt returns the old "delivered_at" field's value of the Shipment entity.
// If the Shipment object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ShipmentMutation) OldDeliveredAt(ctx context.Context) (v *time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ShipmentMutation) ClearDeliveredAt() {
	m.delivered_at = nil
	m.clearedFields[shipment.FieldDeliveredAt] = struct{}{}
}

// DeliveredAtCleared returns if the "delivered_at" field was cleared in this mutation.
func (m *ShipmentMutation) DeliveredAtCleared() bool {
	_, ok := m.clearedFields[shipment.FieldDeliveredAt]
	return ok
}

// ResetDeliveredAt resets all changes to the "delivered_at" field.
func (m *ShipmentMutation) ResetDeliveredAt() {
	m.delivered_at = nil
	delete(m.clearedFields, shipment.FieldDeliveredAt)
}

// ClearShop clears the "shop" edge to the Shop entity.
func (m *ShipmentMutation) ClearShop() {
	m.clearedshop = true
	m.clearedFields[shipment.FieldShopID] = struct{}{}
}

// ShopCleared reports if the "shop" edge to the Shop entity was cleared.
func (m *ShipmentMutation) ShopCleared() bool {
	return m.clearedshop
}
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// ShopID instead. It exists only for internal usage by the builders.
func (m *ShipmentMutation) ShopIDs() (ids []int) {
	if id := m.shop; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetShop resets all changes to the "shop" edge.
func (m *ShipmentMutation) ResetShop() {
	m.shop = nil
	m.clearedshop = false
}
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// OrderID instead. It exists only for internal usage by the builders.
func (m *ShipmentMutation) OrderIDs() (ids []int) {
	if id := m._order; id != nil {
		ids = append(ids, *id)
	}
	return
...
func (m *ShipmentMutation) Fields() []string {
	...
	if m.shop != nil {
		fields = append(fields, shipment.FieldShopID)
	}
	if m._order != nil {
	...
	if m.delivered_at != nil {
		fields = append(fields, shipment.FieldDeliveredAt)
	}
	return fields
}
...
func (m *ShipmentMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(shipment.FieldTrackingNumber) {
		fields = append(fields, shipment.FieldTrackingNumber)
	}
	if m.FieldCleared(shipment.FieldShippedAt) {
		fields = append(fields, shipment.FieldShippedAt)
	}
	if m.FieldCleared(shipment.FieldDeliveredAt) {
		fields = append(fields, shipment.FieldDeliveredAt)
	}
	return fields
}
...
func (m *ShipmentMutation) AddedEdges() []string {
	edges := make([]string, 0, 2)
	if m.shop != nil {
		edges = append(edges, shipment.EdgeShop)
	}
	if m._order != nil {
...
// SetCreatedAt sets the "created_at" field.
func (m *ShippingMethodMutation) SetCreatedAt(t time.Time) {
	m.created_at = &t
}

// CreatedAt returns the value of the "created_at" field in the mutation.
func (m *ShippingMethodMutation) CreatedAt() (r time.Time, exists bool) {
	v := m.created_at
	if v == nil {
		return
	}
...
// OldCreatedAt returns the old "created_at" field's value of the ShippingMethod entity.
// If the ShippingMethod object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ShippingMethodMutation) OldCreatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCreatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetCreatedAt resets all changes to the "created_at" field.
func (m *ShippingMethodMutation) ResetCreatedAt() {
	m.created_at = nil
}

// SetUpdatedAt sets the "updated_at" field.
func (m *ShippingMethodMutation) SetUpdatedAt(t time.Time) {
	m.updated_at = &t
}

// UpdatedAt returns the value of the "updated_at" field in the mutation.
func (m *ShippingMethodMutation) UpdatedAt() (r time.Time, exists bool) {
	v := m.updated_at
	if v == nil {
		return
	}
...
// OldUpdatedAt returns the old "updated_at" field's value of the ShippingMethod entity.
// If the ShippingMethod object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ShippingMethodMutation) OldUpdatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUpdatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetUpdatedAt resets all changes to the "updated_at" field.
func (m *ShippingMethodMutation) ResetUpdatedAt() {
	m.updated_at = nil
}

// SetShopID sets the "shop_id" field.
func (m *ShippingMethodMutation) SetShopID(i int) {
	m.shop = &i
}

// ShopID returns the value of the "shop_id" field in the mutation.
func (m *ShippingMethodMutation) ShopID() (r int, exists bool) {
	v := m.shop
	if v == nil {
		return
	}
...
// OldShopID returns the old "shop_id" field's value of the ShippingMethod entity.
// If the ShippingMethod object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ShippingMethodMutation) OldShopID(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldShopID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetShopID resets all changes to the "shop_id" field.
func (m *ShippingMethodMutation) ResetShopID() {
	m.shop = nil
}

// SetName sets the "name" field.
func (m *ShippingMethodMutation) SetName(s string) {
	m.name = &s
}

// Name returns the value of the "name" field in the mutation.
func (m *ShippingMethodMutation) Name() (r string, exists bool) {
	v := m.name
	if v == nil {
		return
	}
...
// OldName returns the old "name" field's value of the ShippingMethod entity.
// If the ShippingMethod object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ShippingMethodMutation) OldName(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldName is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetName resets all changes to the "name" field.
func (m *ShippingMethodMutation) ResetName() {
	m.name = nil
}

// SetCarrier sets the "carrier" field.
func (m *ShippingMethodMutation) SetCarrier(s string) {
	m.carrier = &s
}

// Carrier returns the value of the "carrier" field in the mutation.
func (m *ShippingMethodMutation) Carrier() (r string, exists bool) {
	v := m.carrier
	if v == nil {
		return
	}
...
// OldCarrier returns the old "carrier" field's value of the ShippingMethod entity.
// If the ShippingMethod object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ShippingMethodMutation) OldCarrier(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCarrier is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetCarrier resets all changes to the "carrier" field.
func (m *ShippingMethodMutation) ResetCarrier() {
	m.carrier = nil
}

// SetFlatRate sets the "flat_rate" field.
func (m *ShippingMethodMutation) SetFlatRate(i int64) {
	m.flat_rate = &i
	m.addflat_rate = nil
}

// FlatRate returns the value of the "flat_rate" field in the mutation.
func (m *ShippingMethodMutation) FlatRate() (r int64, exists bool) {
	v := m.flat_rate
	if v == nil {
		return
	}
...
// OldFlatRate returns the old "flat_rate" field's value of the ShippingMethod entity.
// If the ShippingMethod object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ShippingMethodMutation) OldFlatRate(ctx context.Context) (v int64, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldFlatRate is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldFlatRate requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldFlatRate: %w", err)
	}
	return oldValue.FlatRate, nil
}

// AddFlatRate adds i to the "flat_rate" field.
func (m *ShippingMethodMutation) AddFlatRate(i int64) {
	if m.addflat_rate != nil {
		*m.addflat_rate += i
	} else {
		m.addflat_rate = &i
	}
...
// AddedFlatRate returns the value that was added to the "flat_rate" field in this mutation.
func (m *ShippingMethodMutation) AddedFlatRate() (r int64, exists bool) {
	v := m.addflat_rate
	if v == nil {
		return
	}
...
// ResetFlatRate resets all changes to the "flat_rate" field.
func (m *ShippingMethodMutation) ResetFlatRate() {
	m.flat_rate = nil
	m.addflat_rate = nil
}

// SetIsActive sets the "is_active" field.
func (m *ShippingMethodMutation) SetIsActive(b bool) {
	m.is_active = &b
}

// IsActive returns the value of the "is_active" field in the mutation.
func (m *ShippingMethodMutation) IsActive() (r bool, exists bool) {
	v := m.is_active
	if v == nil {
		return
	}
...
// OldIsActive returns the old "is_active" field's value of the ShippingMethod entity.
// If the ShippingMethod object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ShippingMethodMutation) OldIsActive(ctx context.Context) (v bool, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldIsActive is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetIsActive resets all changes to the "is_active" field.
func (m *ShippingMethodMutation) ResetIsActive() {
	m.is_active = nil
}

// ClearShop clears the "shop" edge to the Shop entity.
func (m *ShippingMethodMutation) ClearShop() {
	m.clearedshop = true
	m.clearedFields[shippingmethod.FieldShopID] = struct{}{}
}

// ShopCleared reports if the "shop" edge to the Shop entity was cleared.
func (m *ShippingMethodMutation) ShopCleared() bool {
	return m.clearedshop
}
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// ShopID instead. It exists only for internal usage by the builders.
func (m *ShippingMethodMutation) ShopIDs() (ids []int) {
	if id := m.shop; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetShop resets all changes to the "shop" edge.
func (m *ShippingMethodMutation) ResetShop() {
	m.shop = nil
	m.clearedshop = false
}
...
func (m *ShippingMethodMutation) Fields() []string {
	fields := make([]string, 0, 7)
	if m.created_at != nil {
		fields = append(fields, shippingmethod.FieldCreatedAt)
	}
	if m.updated_at != nil {
		fields = append(fields, shippingmethod.FieldUpdatedAt)
	}
	if m.shop != nil {
		fields = append(fields, shippingmethod.FieldShopID)
	}
	if m.name != nil {
		fields = append(fields, shippingmethod.FieldName)
	}
	if m.carrier != nil {
		fields = append(fields, shippingmethod.FieldCarrier)
	}
	if m.flat_rate != nil {
		fields = append(fields, shippingmethod.FieldFlatRate)
	}
	if m.is_active != nil {
		fields = append(fields, shippingmethod.FieldIsActive)
	}
	return fields
}
...
func (m *ShippingMethodMutation) AddedEdges() []string {
	edges := make([]string, 0, 1)
	if m.shop != nil {
		edges = append(edges, shippingmethod.EdgeShop)
	}
	return edges
}
...
func (m *ShopMemberMutation) SetLevelID(i int) {
	m.member_tier = &i
}

// LevelID returns the value of the "level_id" field in the mutation.
func (m *ShopMemberMutation) LevelID() (r int, exists bool) {
	v := m.member_tier
	if v == nil {
		return
	}
...
// If the ShopMember object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ShopMemberMutation) OldLevelID(ctx context.Context) (v *int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ShopMemberMutation) SetMemberTierID(id int) {
	m.member_tier = &id
}

// ClearMemberTier clears the "member_tier" edge to the MemberTier entity.
func (m *ShopMemberMutation) ClearMemberTier() {
	m.clearedmember_tier = true
	m.clearedFields[shopmember.FieldLevelID] = struct{}{}
}

// MemberTierCleared reports if the "member_tier" edge to the MemberTier entity was cleared.
func (m *ShopMemberMutation) MemberTierCleared() bool {
	return m.LevelIDCleared() || m.clearedmember_tier
}

// MemberTierID returns the "member_tier" edge ID in the mutation.
func (m *ShopMemberMutation) MemberTierID() (id int, exists bool) {
	if m.member_tier != nil {
		return *m.member_tier, true
	}
	return
}

// MemberTierIDs returns the "member_tier" edge IDs in the mutation.
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// MemberTierID instead. It exists only for internal usage by the builders.
func (m *ShopMemberMutation) MemberTierIDs() (ids []int) {
	if id := m.member_tier; id != nil {
		ids = append(ids, *id)
	}
	return
}

// ResetMemberTier resets all changes to the "member_tier" edge.
func (m *ShopMemberMutation) ResetMemberTier() {
	m.member_tier = nil
	m.clearedmember_tier = false
}
...
func (m *ShopMemberMutation) AddedEdges() []string {
	...
	if m.member_tier != nil {
		edges = append(edges, shopmember.EdgeMemberTier)
	}
	return edges
}
...
func (m *ShopMemberMutation) AddedIDs(name string) []ent.Value {
	...
	case shopmember.EdgeMemberTier:
		if id := m.member_tier; id != nil {
			return []ent.Value{*id}
		}
	}
